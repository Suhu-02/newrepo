...
public class ExcelCode {
	static FileInputStream f; //to read excel file
 	static XSSFWorkbook w; //to represent entire excel workbook
 	static XSSFSheet sh; //to represent sheet of a wb
  
 	public static String readStringData(int row, int col) throws IOException { 
 		f = new FileInputStream("C:\\Users\\gopik\\git\\newrepo\\project1\\src\\main\\resources\\Java.xlsx"); 
